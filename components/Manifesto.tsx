    ...
    <section className="bg-brand-dark relative pt-20 md:pt-32 pb-32">
        ...
        <div className="container mx-auto px-6">
            {cards.map((card, index) => (
                ...
                >
                    <div className={`${card.bg} border border-white/10 p-6 md:p-20 min-h-[50vh] md:min-h-[70vh] flex flex-col justify-between transition-transform duration-500 hover:-translate-y-4 shadow-2xl`}>
