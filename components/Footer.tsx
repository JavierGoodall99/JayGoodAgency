    ...
    <footer id="contact" className="bg-brand-dark pt-20 md:pt-32 pb-12 px-6 border-t border-white/10 min-h-screen flex flex-col justify-between">
      <div className="container mx-auto flex-grow flex flex-col justify-center">
        ...
        <div className="mb-20">
            ...
            <a href="mailto:hello@jaygood.agency" className="group block relative cursor-interactive">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-white/10 pt-12">
            <div>
                ...
                <a href="mailto:hello@jaygood.agency" className="block text-xl text-white hover:text-brand-lime transition-colors">hello@jaygood.agency</a>
                <p className="text-xl text-white mt-2">+1 (555) 019-2834</p>
            </div>
            <div>
